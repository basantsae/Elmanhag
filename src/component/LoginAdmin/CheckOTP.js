...
function CheckOTP() {
  ...
  const handleVerifyOtp = (e) => {
    ...
    if (otp.join('') === generatedOtp) {
      ...
      navigate('/new-password'); //just for test
      ...
      <div className="container-login">
        ...
        <div className="add-login">
          ...
          <div className="input-login">
            {/* <h2>{`أدخل كلمة مرور OTP المرسلة إلى ${contact}`}</h2> */}
            <h2>{`${contact} المرسلة الي OTP أدخل كلمة مرور`}</h2>
                ...
                <div className="resend">
                  <p>
                    <span className="resend-link" onClick={() => {
                      ...
                      <p>لم تتلقَ الرمز؟ <a href='/#'>إعادة إرساله</a></p>
                    </span>
                  </p>
                </div>

                <button type="submit" className="verify-otp-button">إرسال</button>
              </form>
            </div>
          </div>
        </div>
